...
class ReleaseRecord(Base):
    ...
    assurance_actor_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
    it_actor_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
    director_decision_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
    director_actor_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
